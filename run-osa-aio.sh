...
for config_file in /etc/network/interfaces.d/osa_interfaces.cfg /etc/openstack_deploy/user_variables.yml /etc/openstack_deploy/openstack_user_config.yml /etc/openstack_deploy/user_secrets.yml
do
